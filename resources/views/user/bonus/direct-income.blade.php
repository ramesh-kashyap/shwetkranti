            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Self Income</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Self Income</h4>
                            </div>
                            <div class="card-body">

                                <div id="example_wrapper" class="dataTables_wrapper">
                                    <form action="{{ route('user.Self_income') }}" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{ route('user.Self_income') }}" style="padding: 0.6rem 2rem;"
                                                        name="reset"
                                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                                        value="Reset">Reset</a>
                                                </div>
