					...
					<div class="col-xl-4 col-xxl-4 col-sm-6">
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
                                       {{ currency() }} {{ number_format(Auth::user()->sponsor_bonus->sum('comm'), 2) }}   </h2>
									<span class="text-white fs-18">Ocean  Vip Income</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
                                       {{ currency() }} {{ number_format(Auth::user()->reward_bonus->sum('comm'), 2) }}  </h2>
									<span class="text-white fs-18">Direct Sponsor Income</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
                                       {{ currency() }} {{ number_format(Auth::user()->level_bonus->sum('comm'), 2) }}  </h2>
									<span class="text-white fs-18">Direct Sponor Level Income</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
                                       {{ currency() }} {{ number_format(Auth::user()->leadership_bonus->sum('comm'), 2) }}  </h2>
									<span class="text-white fs-18">Team Bonanza</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
                                    {{ currency() }} {{ number_format(Auth::user()->totalincome(), 2) }}   </h2>
									<span class="text-white fs-18">Total Income</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-xxl-4 col-sm-6">
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">{{ currency() }} {{ number_format(Auth::user()->withdraw(), 2) }}  </h2>
									<span class="text-white fs-18">Total Withdrawal</span>
								</div>
							</div>
						</div>
					</div>
