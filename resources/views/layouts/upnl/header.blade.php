...
<head>
    ...
    <style>
        .dlab-demo-panel .dlab-demo-trigger,.DZ-theme-btn,.at-expanding-share-button-toggle
        {
                ...
                <li><a href="{{route('user.walletTransfer')}}" class="ai-icon" aria-expanded="false">
                  ...
                  <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                                                        <li><a href="{{route('user.Self_income')}}">Self Income</a></li>
                                                                                    <li><a href="{{route('user.ocenan_income')}}">Ocean Vip Income </a></li>

                                                                                           

                            <li><a href="{{route('user.Direct_Sponsor_Income')}}">Direct Sponsor Income</a></li>
                               <li><a href="{{route('user.direct_sponor_level')}}">Direct Sponsor Level Income</a></li>

                            <li><a href="{{route('user.team_bonanza')}}">Team Bonanza</a></li>
